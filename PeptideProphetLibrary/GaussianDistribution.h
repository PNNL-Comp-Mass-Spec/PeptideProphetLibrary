...
class GaussianDistribution : public ContinuousDistribution {
 public:
  ...
  GaussianDistribution(float maxdiff);
  float getProb(float val);
  float getProb(int val);
  float getGaussianProb(float val, float mean, float stdev);
  ...
  float gaussianSlice(float left_val, float right_val);
  float gaussianSlice(float num, float left_val, float right_val, float mean, float stdev);
  double N(double z);
